...
<div class="col-sm-offset-4 col-sm-4 " style="padding-top:5%;"> 
        ...
        <div style="padding:40px 50px;">
            <form method="post" name="MyForm" action="facultyad" autocomplete="off">
            
             <div class="form-group">
             <label for="number"><span class="glyphicon glyphicon-user"></span> Bus No.</label>
              <input type="text" class="form-control" id="number" name ="busn" placeholder="Enter username">
            </div>
            
              <div class="form-group">
             <label for="routename"><span class="glyphicon glyphicon-user"></span> Route name.</label>
              <input type="text" class="form-control" id="routename" name ="busr" placeholder="Enter username">
