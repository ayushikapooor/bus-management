...
<body>
                <ul class="main-nav">
                    ...
                    <li><a href="update.jsp">Update Route</a></li>
                </ul>
...
<div class="col-sm-offset-4 col-sm-4 " style="padding-top:5%;"> 
        ...
        <div class="form-group">
             <label for="number"><span class="glyphicon glyphicon-user"></span> Route Name</label>
              <input type="text" class="form-control" id="number" name ="username" placeholder="Enter username">
            </div>

		    </div>
            <center> <button type="submit" class="btn btn-danger" onclick="myValidation()"> Update</button></center>
          </form>
        </div>
      </div>
